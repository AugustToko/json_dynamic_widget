...
class JsonExampleWidgetBuilder extends _JsonExampleWidgetBuilder {
  ...
  }) => JsonExampleWidgetBuilder(args: map);
  ...
  _ExampleWidget buildCustom({
    ...
    final dataDecoded = _decodeName(value: model.data);

    return _ExampleWidget(dataDecoded);
  }
}
...
class JsonExampleWidgetBuilderModel extends JsonWidgetBuilderModel {
  const JsonExampleWidgetBuilderModel(super.args, {required this.data});
  ...
  static JsonExampleWidgetBuilderModel? maybeFromDynamic(
    ...
    if (map != null) {
      ...
      if (map is JsonExampleWidgetBuilderModel) {
        ...
        result = JsonExampleWidgetBuilderModel(args, data: map['name']);
      }
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    return JsonClass.removeNull({'name': nameEncoded, ...args});
  }
}

class ExampleWidgetSchema {
  static const id =
      'https://peiffer-innovations.github.io/flutter_json_schemas/schemas/json_dynamic_widget_example/example_widget.json';
  ...
  static final schema = <String, Object>{
    ...
    'properties': {'name': _JsonExampleWidgetBuilder._nameSchema()},
    'required': ['name'],
  };
}
